...
class MedilineRepository {
  Future<GetAppointmentResponse?> getappointementsofPatient() async {
    GetAppointmentResponse? response =
      ...
      url:
          "${ApiConstants.getAllAppointments}patientId=${sharedPrefs.patientId}",
  ...
  Future<GetAppointmentResponse?> getAppointmentsSearch(
    ...
    GetAppointmentResponse? response =
        await ApiRequest<String, GetAppointmentResponse>().get(
      url:
          "${ApiConstants.getAllAppointments}patientId=${sharedPrefs.patientId}&search=$search",
      reponseFromJson: getAppointmentResponseFromJson,
    );
    return response;
  }
  ...
  //share appointment
  Future<Response<ShareAppointmentResponse>?> shareAppointment(
      {required ShareAppointmentRequest shareAppointmentRequest}) async {
    Response<ShareAppointmentResponse>? response =
        await ApiRequest<ShareAppointmentRequest, ShareAppointmentResponse>()
            .post(
